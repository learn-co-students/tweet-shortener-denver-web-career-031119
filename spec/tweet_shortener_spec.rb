...
describe 'tweet shortener' do
  ...
  let(:tweet_five)  {"I'm running out of example tweets for you guys, which is weird, because I'm a writer and this is just writing and I tweet all day. 4 real, u guys. 4 real."}
